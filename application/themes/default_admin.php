...
<head>
  ...
  <title>ISM | <?php echo $titre; ?></title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="icon" href="<?php echo site_url(); ?>assets/img/logo.jpg" type="image/x-icon">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b><img src="<?php echo site_url("assets/img/logo.jpg"); ?>" width="40px" height="40px"/></b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $_SESSION['nom']." ".$_SESSION['prenom']; ?> - <?php echo $_SESSION['fonction']; ?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $_SESSION['fonction']; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Géneral</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url("Professeur/index"); ?>"><i class="fa fa-circle-o"></i>Professeurs</a></li>
            <li><a href="<?php echo site_url("Etudiant/index"); ?>"><i class="fa fa-circle-o"></i>Etudiants</a></li>
            <li><a href="index2.html"><i class="fa fa-circle-o"></i>Personnel à ISM</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Droit d'inscription/ reinscription</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>Ecolage</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i>Droit de stage</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i>Droit d'examen</a></li>
            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>Frais d'excursion</a></li>
            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>Frais de voyage d'etude</a></li>
          </ul>
        </li>
        
        <li>
          <a href="#">
            <i class="fa fa-folder"></i> <span>Calendrier</span>
          </a>
        </li>

        <li>
          <a href="#">
            <i class="fa fa-folder"></i> <span>Actualité</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url("Admin/create_access_user"); ?>">
            <i class="fa fa-files-o"></i>
            <span>Créer un point d'accès</span>
          </a>
        </li>
        <li>
...
<script src="<?php echo site_url(); ?>assets/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.fr.js"></script>
<!-- SlimScroll -->
...
<script>
  $(function () {
    ...
    var h = $("input[type='search']").val();
    $("input[type='search']").attr("placeholder","rechercher prenom ici");
